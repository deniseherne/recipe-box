...
The six-meal starter includes the selected keto-style menu, proposed sides and 8–12 servings per meal for a family of four with leftovers. Suggestions choose unplanned meals from the existing recipe collection, with optional untried, keto-style, no-seafood, no-chili and no-beef-tips filters. Automatic selections always exclude asparagus and cauliflower by title and ingredients, including starter sides, regardless of older saved settings. Existing saved plans and manual selections are preserved. Suggestions do not fetch new recipes or calculate nutritional macros.
